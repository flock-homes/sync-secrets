...
class Secrets {
	...
	constructor(options={}) {
		...
		const accessKeyId = process.env.ENV_AWS_ACCESS_KEY_ID || process.env.AWS_ACCESS_KEY_ID
		const secretAccessKey = process.env.ENV_AWS_SECRET_ACCESS_KEY || process.env.AWS_SECRET_ACCESS_KEY
