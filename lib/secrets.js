...
class Secrets {
	...
	constructor(options={}) {
		...
		this.secretsmanager = new SecretsManager({
			region: this.region,
			credentials: {
				accessKeyId: process.env.ENV_AWS_ACCESS_KEY_ID || process.env.AWS_ACCESS_KEY_ID,
				secretAccessKey: process.env.ENV_AWS_SECRET_ACCESS_KEY || process.env.AWS_SECRET_ACCESS_KEY,
			}
		});
